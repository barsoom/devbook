...
This [is safe](https://www.enterprisedb.com/blog/adding-new-table-columns-default-values-postgresql-11) since Postgres 11, even with nullable columns, as long as the value is non-volatile – same as when [adding a column with a default](#adding-columns).
